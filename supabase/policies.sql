...
create policy "Admins have full access to professor profiles"
    on professor_profiles for all
    using (auth.user_role() = 'admin');
...
create policy "Admins have full access to reference templates"
    on reference_templates for all
    using (auth.user_role() = 'admin');

create policy "Admins have full access to reference requests"
